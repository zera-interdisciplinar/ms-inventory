...
class UpdateModelManufacturerImplTest {
    ...
    void shouldUpdate() {
        ...
        UpdateModelManufacturerImpl useCase = new UpdateModelManufacturerImpl(modelRepository);
        Model result = useCase.execute(Fixtures.UNIT, id, "Zera Labs");

        assertEquals("Zera Labs", result.getManufacturer());
    ...
    void shouldThrowWhenNotFoundInThisUnit() {
        ...
        assertThrows(ModelNotFoundException.class, () -> useCase.execute(Fixtures.OTHER_UNIT, id, "Zera Labs"));
    }
}
